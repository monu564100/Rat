...
<head>
    ...
    <meta http-equiv="refresh" content="100" > <!-- her 100 saniyede 1 sayfay覺 yenile -->
    <title>RAPTOR</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
                <a class="navbar-brand" href="index.php">UR RAT 🧑‍💻</a>
            </div>
        </div>
    </div>
</nav>
...
<div class="container-fluid">
        ...
        <div class="col-lg-2">
            <div class="list-group">
               ...
               <!-- <a href="kontrol-panel.php?<?php echo 'target='.$_GET['target'];?>&type=6" class="list-group-item <?php if ($_GET['type']==6){ echo 'active';}?>">Listening to media</a> -->
                ...
                <!-- <a href="kontrol-panel.php?<?php echo 'target='.$_GET['target'];?>&type=16" class="list-group-item <?php if ($_GET['type']==16){ echo 'active';}?>">Whattsap Mesajlar覺</a> -->
                <!-- <a href="kontrol-panel.php?<?php echo 'target='.$_GET['target'];?>&type=17" class="list-group-item <?php if ($_GET['type']==17){ echo 'active';}?>">Kullan覺c覺ya Ses Dinlettir</a> -->
    ...
    <div class="row tall-row">
        <div class="col-md-offset-8">
            <p>Created by <a href="#">Update by @Unknown_Reason.</a>. &copy;  2023-2024</p>
        </div>
    </div>
